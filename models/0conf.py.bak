...
nuages_excl =('ministre','monsieur',u'collègue','madame','premier','cher','effet','commission','parlementaire','député','deux','amendement','sujet','texte','an','fois','lieu','trois','mois','rapporteur','cinq','quant','quel','dix','nom','quelle',u'deuxième','vingt','point')
